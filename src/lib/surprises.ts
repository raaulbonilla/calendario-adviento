...
export const surprises: Record<number, Surprise> = {
  1: {
    ...
    message:
      "Comienza nuestro viaje de adviento juntos. Cada día tendrás una nueva sorpresa que he preparado especialmente para ti. Te amo más de lo que las palabras pueden expresar. 💕",
  },
  2: {
    type: "image",
  ...
  3: {
    ...
    message:
      "Tu sonrisa ilumina incluso los días más oscuros. La forma en que me miras me hace sentir como la persona más especial del mundo.",
  },
  4: {
    type: "image",
    title: "Nuestro lugar",
  ...
  5: {
    ...
    message:
      "Sueño con todos los momentos que nos quedan por vivir juntos. Cada día a tu lado es un regalo.",
  },
  6: {
    type: "link",
  ...
  7: {
    ...
    title: "Promesa",
    message:
      "Prometo estar siempre a tu lado, en los buenos y malos momentos, celebrando tus alegrías y consolando tus penas.",
  },
  8: {
    type: "image",
  ...
  9: {
    ...
    title: "Tu risa",
    message:
      "Tu risa es mi melodía favorita. Haría cualquier cosa solo para verte sonreír.",
  },
  10: {
    type: "text",
    title: "Razones por las que te amo",
    message:
      "Te amo por cómo eres, por cómo me haces sentir, por tu bondad, tu inteligencia, tu belleza interior y exterior, y por mil razones más que descubro cada día.",
  },
  11: {
    type: "image",
    ...
    mediaUrl:
      "https://images.unsplash.com/photo-1482148453744-cfb5b3b0d0a5?w=800&auto=format&fit=crop",
  },
  12: {
    type: "text",
    title: "Aventuras",
    message:
      "Quiero vivir mil aventuras más a tu lado. Explorar el mundo contigo, crear nuevos recuerdos inolvidables.",
  },
  13: {
    type: "text",
    title: "Tu apoyo",
    message:
      "Gracias por estar siempre ahí, por creer en mí incluso cuando yo no lo hago. Eres mi mayor apoyo y mi fuerza.",
  },
  14: {
    type: "image",
    title: "Corazones",
  ...
  15: {
    ...
    message:
      "Imagino nuestro futuro juntos y solo veo felicidad, amor y complicidad. Cada día estoy más seguro de que eres la persona con quien quiero compartir mi vida.",
  },
  16: {
    type: "link",
    title: "Vale especial",
  ...
  17: {
    ...
    title: "Tu esencia",
    message:
      "Amo tu esencia, esa chispa única que te hace ser tú. No cambiaría nada de ti.",
  },
  18: {
    type: "image",
  ...
  19: {
    ...
    message:
      "Gracias por enseñarme lo que es el amor verdadero. Por mostrarme que el amor no solo existe en las películas.",
  },
  20: {
    type: "text",
    title: "Cada momento",
    message:
      "Cada momento contigo es un tesoro. Desde las grandes aventuras hasta los pequeños momentos en casa, todo es especial porque estás tú.",
  },
  21: {
    type: "image",
    title: "Juntos",
    ...
    mediaUrl:
      "https://images.unsplash.com/photo-1474552226712-ac0f0961a954?w=800&auto=format&fit=crop",
  },
  22: {
    type: "text",
    title: "Tu mirada",
    message:
      "En tu mirada encuentro hogar. Cuando me miras, sé que estoy exactamente donde debo estar.",
  },
  23: {
    type: "text",
    title: "Casi Navidad",
    message:
      "Solo quedan dos días para Navidad, pero el mejor regalo ya lo tengo: tu amor.",
  },
  24: {
    type: "gallery",
    title: "Nuestros mejores momentos",
    message:
      "Una colección de los momentos más especiales que hemos vivido juntos.",
    mediaUrl: [
  ...
  25: {
    ...
    message:
      "🎄 Hoy es el día más especial del año. Espero que este calendario te haya hecho sonreír tanto como tú me haces sonreír a mí cada día. Te amo con todo mi corazón. Feliz Navidad, mi amor. Que este sea el primero de muchos diciembres juntos. Con todo mi amor, para siempre tuyo. 💕✨",
  },
};
