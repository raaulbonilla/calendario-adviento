...
const gridLayout = [
  { order: 15, size: "medium" },
  { order: 3, size: "large" },
  { order: 18, size: "xlarge" },
  { order: 7, size: "medium" },
  { order: 22, size: "large" },
  { order: 1, size: "xlarge" },
  { order: 11, size: "medium" },
  { order: 20, size: "large" },
  { order: 5, size: "xlarge" },
  { order: 14, size: "medium" },
  { order: 9, size: "large" },
  { order: 23, size: "xlarge" },
  { order: 2, size: "medium" },
  { order: 17, size: "large" },
  { order: 6, size: "xlarge" },
  { order: 21, size: "medium" },
  { order: 10, size: "large" },
  { order: 4, size: "xlarge" },
  { order: 19, size: "medium" },
  { order: 8, size: "large" },
  { order: 24, size: "xlarge" },
  { order: 13, size: "medium" },
  { order: 16, size: "large" },
  { order: 12, size: "xxxlarge" },
];
...
export function CalendarGrid() {
  ...
  const sortedDays = dayStatuses
    .map((status, index) => ({
      status,
      layout: gridLayout[index % gridLayout.length],
    }))
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3 w-full max-w-7xl">
                {sortedDays.map(({ status, layout }) => {
                  ...
                  switch (layout.size) {
                    ...
                    case "medium":
                      sizeClass =
                        "w-[110px] h-[110px] md:w-[135px] md:h-[135px]";
                      break;
                    case "medium-large":
                      sizeClass =
                    ...
                    case "large":
                      sizeClass =
                        "w-[130px] h-[130px] md:w-[165px] md:h-[165px]";
                      break;
                    case "large-xl":
                      sizeClass =
                    ...
                    case "xlarge":
                      sizeClass =
                        "w-[150px] h-[150px] md:w-[195px] md:h-[195px]";
                      break;
                    case "xxlarge":
                      sizeClass =
                        "w-[165px] h-[165px] md:w-[215px] md:h-[215px]";
                      break;
                    case "xxxlarge":
                      sizeClass =
                    ...
                    case "mega":
                      sizeClass =
                        "w-[195px] h-[195px] md:w-[260px] md:h-[260px]";
                      break;
                  }
